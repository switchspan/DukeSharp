...
namespace Duke.Test
{
    ...
    {
        private PersonNameComparator _comparator;

        [SetUp]
        public void Init()
        {
            // Setup code goes here...
            _comparator = new PersonNameComparator();
        }
        ...
        [Test]
        public void Compare_CloseStrings_ReturnsDoubleValue()
        {
            const string val1 = "Al Smith";
            const string val2 = "Albert Smith";
        ...
        {
            const string val1 = "Alberto Smythes";
            const string val2 = "Albert Smith";
            double actual = _comparator.Compare(val1, val2);
            Console.WriteLine(String.Format("Compare result = {0}", actual));
            Assert.IsInstanceOf<double>(actual);
        ...
        {
            const string val1 = "John Doe";
            const string val2 = "John Doe";
            double actual = _comparator.Compare(val1, val2);
            Console.WriteLine(String.Format("Compare result = {0}", actual));
            Assert.IsInstanceOf<double>(actual);
